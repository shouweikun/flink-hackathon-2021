...
class DummySourceFunction(val der: DeserializationSchema[RowData]) extends RichSourceFunction[RowData]{
  ...
  override def run(sourceContext: SourceFunction.SourceContext[RowData]): Unit = {
